  ...
  return (
    <Select.Trigger
      ...
      className={twMerge(
        ...
        'focus:border-violet-300 focus:ring-4 focus:ring-violet-100 dark:focus:border-violet-500 dark:focus:ring-violet-500/10 focus:bg-violet-25 dark:focus:bg-zinc-900 transition-all duration-200 ease-in-out',
        props.className,
      )}
    >
      {children}
